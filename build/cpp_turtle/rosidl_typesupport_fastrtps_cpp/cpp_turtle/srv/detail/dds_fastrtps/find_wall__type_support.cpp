...
#include "cpp_turtle/srv/detail/find_wall__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cpp_turtle::srv::FindWall_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cpp_turtle::srv::FindWall_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cpp_turtle::srv::FindWall_Request *>(
    untyped_ros_message);
...
{
  return &cpp_turtle::srv::typesupport_fastrtps_cpp::_FindWall_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = cpp_turtle::srv::FindWall_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cpp_turtle::srv::FindWall_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<cpp_turtle::srv::FindWall_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &cpp_turtle::srv::typesupport_fastrtps_cpp::_FindWall_Response__handle;
}
...
{
  return &cpp_turtle::srv::typesupport_fastrtps_cpp::_FindWall__handle;
}
