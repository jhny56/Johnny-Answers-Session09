...
#include "cpp_turtle/action/detail/measure_lap_time__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const cpp_turtle::action::MeasureLapTime_Goal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cpp_turtle::action::MeasureLapTime_Goal & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cpp_turtle::action::MeasureLapTime_Goal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cpp_turtle::action::MeasureLapTime_Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cpp_turtle::action::MeasureLapTime_Goal *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_cpp_turtle
const rosidl_message_type_support_t *
get_message_type_support_handle<cpp_turtle::action::MeasureLapTime_Goal>()
{
  return &cpp_turtle::action::typesupport_fastrtps_cpp::_MeasureLapTime_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cpp_turtle, action, MeasureLapTime_Goal)() {
  return &cpp_turtle::action::typesupport_fastrtps_cpp::_MeasureLapTime_Goal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_cpp_turtle
cdr_serialize(
  const cpp_turtle::action::MeasureLapTime_Result & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: total_time
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cpp_turtle::action::MeasureLapTime_Result & ros_message)
{
  // Member: total_time
  cdr >> ros_message.total_time;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = cpp_turtle::action::MeasureLapTime_Result;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cpp_turtle::action::MeasureLapTime_Result *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<cpp_turtle::action::MeasureLapTime_Result *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &cpp_turtle::action::typesupport_fastrtps_cpp::_MeasureLapTime_Result__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cpp_turtle, action, MeasureLapTime_Result)() {
  return &cpp_turtle::action::typesupport_fastrtps_cpp::_MeasureLapTime_Result__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_cpp_turtle
cdr_serialize(
  const cpp_turtle::action::MeasureLapTime_Feedback & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: elapsed_time
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cpp_turtle::action::MeasureLapTime_Feedback & ros_message)
{
  // Member: elapsed_time
  cdr >> ros_message.elapsed_time;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = cpp_turtle::action::MeasureLapTime_Feedback;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cpp_turtle::action::MeasureLapTime_Feedback *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<cpp_turtle::action::MeasureLapTime_Feedback *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &cpp_turtle::action::typesupport_fastrtps_cpp::_MeasureLapTime_Feedback__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cpp_turtle, action, MeasureLapTime_Feedback)() {
  return &cpp_turtle::action::typesupport_fastrtps_cpp::_MeasureLapTime_Feedback__handle;
}
...
// functions for cpp_turtle::action::MeasureLapTime_Goal already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_cpp_turtle
cdr_serialize(
  const cpp_turtle::action::MeasureLapTime_SendGoal_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ...
    cdr);
  // Member: goal
  cpp_turtle::action::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.goal,
    cdr);
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cpp_turtle::action::MeasureLapTime_SendGoal_Request & ros_message)
{
  // Member: goal_id
  ...
  // Member: goal
  cpp_turtle::action::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment +=
    cpp_turtle::action::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        cpp_turtle::action::typesupport_fastrtps_cpp::max_serialized_size_MeasureLapTime_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = cpp_turtle::action::MeasureLapTime_SendGoal_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cpp_turtle::action::MeasureLapTime_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<cpp_turtle::action::MeasureLapTime_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &cpp_turtle::action::typesupport_fastrtps_cpp::_MeasureLapTime_SendGoal_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cpp_turtle, action, MeasureLapTime_SendGoal_Request)() {
  return &cpp_turtle::action::typesupport_fastrtps_cpp::_MeasureLapTime_SendGoal_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_cpp_turtle
cdr_serialize(
  const cpp_turtle::action::MeasureLapTime_SendGoal_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: accepted
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cpp_turtle::action::MeasureLapTime_SendGoal_Response & ros_message)
{
  // Member: accepted
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = cpp_turtle::action::MeasureLapTime_SendGoal_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cpp_turtle::action::MeasureLapTime_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<cpp_turtle::action::MeasureLapTime_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &cpp_turtle::action::typesupport_fastrtps_cpp::_MeasureLapTime_SendGoal_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cpp_turtle, action, MeasureLapTime_SendGoal_Response)() {
  return &cpp_turtle::action::typesupport_fastrtps_cpp::_MeasureLapTime_SendGoal_Response__handle;
}
...
{
  return &cpp_turtle::action::typesupport_fastrtps_cpp::_MeasureLapTime_SendGoal__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cpp_turtle, action, MeasureLapTime_SendGoal)() {
  return &cpp_turtle::action::typesupport_fastrtps_cpp::_MeasureLapTime_SendGoal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_cpp_turtle
cdr_serialize(
  const cpp_turtle::action::MeasureLapTime_GetResult_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cpp_turtle::action::MeasureLapTime_GetResult_Request & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = cpp_turtle::action::MeasureLapTime_GetResult_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cpp_turtle::action::MeasureLapTime_GetResult_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<cpp_turtle::action::MeasureLapTime_GetResult_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &cpp_turtle::action::typesupport_fastrtps_cpp::_MeasureLapTime_GetResult_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cpp_turtle, action, MeasureLapTime_GetResult_Request)() {
  return &cpp_turtle::action::typesupport_fastrtps_cpp::_MeasureLapTime_GetResult_Request__handle;
}
...
// forward declaration of message dependencies and their conversion functions
// functions for cpp_turtle::action::MeasureLapTime_Result already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_cpp_turtle
cdr_serialize(
  const cpp_turtle::action::MeasureLapTime_GetResult_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cpp_turtle::action::MeasureLapTime_GetResult_Response & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        cpp_turtle::action::typesupport_fastrtps_cpp::max_serialized_size_MeasureLapTime_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = cpp_turtle::action::MeasureLapTime_GetResult_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cpp_turtle::action::MeasureLapTime_GetResult_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<cpp_turtle::action::MeasureLapTime_GetResult_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &cpp_turtle::action::typesupport_fastrtps_cpp::_MeasureLapTime_GetResult_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cpp_turtle, action, MeasureLapTime_GetResult_Response)() {
  return &cpp_turtle::action::typesupport_fastrtps_cpp::_MeasureLapTime_GetResult_Response__handle;
}
...
{
  return &cpp_turtle::action::typesupport_fastrtps_cpp::_MeasureLapTime_GetResult__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cpp_turtle, action, MeasureLapTime_GetResult)() {
  return &cpp_turtle::action::typesupport_fastrtps_cpp::_MeasureLapTime_GetResult__handle;
}
...
// functions for cpp_turtle::action::MeasureLapTime_Feedback already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_cpp_turtle
cdr_serialize(
  const cpp_turtle::action::MeasureLapTime_FeedbackMessage & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cpp_turtle::action::MeasureLapTime_FeedbackMessage & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        cpp_turtle::action::typesupport_fastrtps_cpp::max_serialized_size_MeasureLapTime_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = cpp_turtle::action::MeasureLapTime_FeedbackMessage;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cpp_turtle::action::MeasureLapTime_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<cpp_turtle::action::MeasureLapTime_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &cpp_turtle::action::typesupport_fastrtps_cpp::_MeasureLapTime_FeedbackMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cpp_turtle, action, MeasureLapTime_FeedbackMessage)() {
  return &cpp_turtle::action::typesupport_fastrtps_cpp::_MeasureLapTime_FeedbackMessage__handle;
}
