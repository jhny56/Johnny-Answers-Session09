...
static const _FindWall_Request_type_support_symbol_names_t _FindWall_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cpp_turtle, srv, FindWall_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cpp_turtle, srv, FindWall_Request)),
  }
};
...
{
  return &::cpp_turtle::srv::rosidl_typesupport_cpp::FindWall_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cpp_turtle, srv, FindWall_Request)() {
  return get_message_type_support_handle<cpp_turtle::srv::FindWall_Request>();
}
...
static const _FindWall_Response_type_support_symbol_names_t _FindWall_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cpp_turtle, srv, FindWall_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cpp_turtle, srv, FindWall_Response)),
  }
};
...
{
  return &::cpp_turtle::srv::rosidl_typesupport_cpp::FindWall_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cpp_turtle, srv, FindWall_Response)() {
  return get_message_type_support_handle<cpp_turtle::srv::FindWall_Response>();
}
...
static const _FindWall_type_support_symbol_names_t _FindWall_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cpp_turtle, srv, FindWall)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cpp_turtle, srv, FindWall)),
  }
};
...
{
  return &::cpp_turtle::srv::rosidl_typesupport_cpp::FindWall_service_type_support_handle;
}
